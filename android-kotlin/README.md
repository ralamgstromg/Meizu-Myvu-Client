...
- **Intercepción Rápida de WhatsApp y Telegram (`VoiceActionRouter.kt`)**: Router directo (<5ms) con limpieza de prefijos (*"enviar un mensaje de whatsapp a"*, *"envía un mensaje por telegram a"*). Al decir *"envió un mensaje de WhatsApp a Matías Castro Hola hijo cómo estás"*, se extrae limpiamente el contacto y el cuerpo del mensaje, disparando la acción de mensajería en el teléfono.
