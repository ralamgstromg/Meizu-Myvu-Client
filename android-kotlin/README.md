...
- **Servicio Whisper STT Local Habilitado (Puerto 8181)**: Inferencia de voz a texto 100% local a través de `http://127.0.0.1:8181/v1/audio/transcriptions` integrando el codificador nativo en memoria [`WavAudioEncoder.kt`](file:///home/rcastro/Documentos/negex/Meizu-Myvu-Client/android-kotlin/app/src/main/java/com/myvu/client/ai/WavAudioEncoder.kt), eliminando cualquier excepción JNI en procesadores MediaTek (`mt6878`).
